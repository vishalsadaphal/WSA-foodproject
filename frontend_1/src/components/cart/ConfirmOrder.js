...
const ConfirmOrder = () => {
    ...
    const deliverPrice = itemsPrice > 200 ? 0 : 25;
    const taxPrice = Number((0.05 * itemsPrice).toFixed(2));
    const finalTotal = (itemsPrice + deliverPrice + taxPrice).toFixed(2);
            ...
            <div className='row d-flex justify-between'>
                ...
                <div className='col-12 col-lg-3 my-5 cartt'>
                    <div id='order_summary'>
                        ...
                        <hr />
                        <button className='btn btn0primary btn-block' id='checkout_btn' onClick={processToPayment}>{" "} Procced to Payment</button>
                        <br />
                    </div>
                </div>
            </div >
