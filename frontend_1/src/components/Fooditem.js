        ...
        <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
            <div className='card p-3 rounded'>
                <img className='card-img-top mx-auto'
                    src={fooditem.images[0].url} alt={fooditem.name}
                >
                ...
                <div className='card-body d-flex flex-column'>
                    ...
                    {
                        !showButtons && (<button type='button' id='cart_btn' className='btn btn-primary d-inline ml-4'
                    ...
                    <p >
                        Status: <span id="stock_status" className={fooditem.stock > 0 ? "greenColor" : "redColor"}>{fooditem.stock > 0 ? "In Stock" : "Out Stock"}</span>
                    </p>
                </div>
            </div>
        </div >
